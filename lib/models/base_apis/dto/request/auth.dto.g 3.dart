...
ChangeProfileAfterSignUpRequest _$ChangeProfileAfterSignUpRequestFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ChangeProfileAfterSignUpRequestToJson(
    ChangeProfileAfterSignUpRequest instance) {
  final val = <String, dynamic>{};
