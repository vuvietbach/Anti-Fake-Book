...
class _FriendPageContentState extends State<FriendPageContent> {
  ...
  final List<Friend> friendRequests = [
    ...
    Friend('Friend 2', 'assets/images/PostImage_02.jpeg'),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      CircleAvatar(
                        radius: 48,
                        backgroundImage: AssetImage(friendRequests[index].imageUrl),
                      ),
                      SizedBox(width: 14),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            children: [
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  minimumSize: Size(130, 38), // Đặt độ dài và chiều cao của nút
                                ),
                                child: Text(
                                  'Chấp nhận',
                                  style: TextStyle(
                              ...
                              ElevatedButton(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.black, // Đổi màu chữ sang màu đen
                                  ),
                                ),
                              ),
                            ],
